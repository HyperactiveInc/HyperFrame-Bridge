const HyperFrame = {
    ...
    getContent: () => {
        var request = $.getJSON('./app/assets/data/contentItems.json', (response) => {
            HyperFrame.content = response
        })
        request.fail((response) => {
            console.error('get contentItems error', response)
        })
    },
    ...
    init: () => {
        ...
        if (!HyperFrame.content) {
            console.log('get content')
            HyperFrame.getContent();
        }
    },
}
